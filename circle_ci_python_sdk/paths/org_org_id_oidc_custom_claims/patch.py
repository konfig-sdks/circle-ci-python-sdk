...
class BaseApi(api_client.Api):
    ...
    def _update_org_claims_mapped_args(
        self,
        org_id: str,
    ...
    async def _aupdate_org_claims_oapg(
        self,
...
class UpdateOrgClaimsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_org_claims(
        self,
        org_id: str,
        audience: typing.Optional[PatchClaimsRequestAudience] = None,
        ttl: typing.Optional[JSONDuration] = None,
        **kwargs,
        ...
        args = self._update_org_claims_mapped_args(
            org_id=org_id,
            audience=audience,
            ttl=ttl,
        )
        return await self._aupdate_org_claims_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_org_claims(
        self,
        org_id: str,
        audience: typing.Optional[PatchClaimsRequestAudience] = None,
        ttl: typing.Optional[JSONDuration] = None,
        ...
        return self._update_org_claims_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateOrgClaims(BaseApi):
    ...
    async def aupdate_org_claims(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_org_claims(
            org_id=org_id,
            audience=audience,
            ttl=ttl,
            **kwargs,
    ...
    def update_org_claims(
        ...
        raw_response = self.raw.update_org_claims(
            org_id=org_id,
            audience=audience,
            ttl=ttl,
        )
