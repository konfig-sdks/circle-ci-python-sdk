...
class BaseApi(api_client.Api):
    ...
    def _delete_org_claims_mapped_args(
        self,
        org_id: str,
        claims: str,
    ...
    async def _adelete_org_claims_oapg(
        self,
...
class DeleteOrgClaimsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_org_claims(
        self,
        org_id: str,
        claims: str,
        **kwargs,
        ...
        args = self._delete_org_claims_mapped_args(
            org_id=org_id,
            claims=claims,
        )
        return await self._adelete_org_claims_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def delete_org_claims(
        self,
        org_id: str,
        claims: str,
    ) -> typing.Union[
        ...
        return self._delete_org_claims_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class DeleteOrgClaims(BaseApi):
    ...
    async def adelete_org_claims(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_org_claims(
            org_id=org_id,
            claims=claims,
            **kwargs,
        )
    ...
    def delete_org_claims(
        ...
        raw_response = self.raw.delete_org_claims(
            org_id=org_id,
            claims=claims,
        )
        if validate:
