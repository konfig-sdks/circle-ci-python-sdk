...
class BaseApi(api_client.Api):
    ...
    def _get_policy_bundle_mapped_args(
        self,
        owner_id: str,
        context: str,
    ...
    async def _aget_policy_bundle_oapg(
        self,
...
class GetPolicyBundleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_policy_bundle(
        self,
        owner_id: str,
        context: str,
        **kwargs,
        ...
        args = self._get_policy_bundle_mapped_args(
            owner_id=owner_id,
            context=context,
        )
        return await self._aget_policy_bundle_oapg(
    ...
    def get_policy_bundle(
        ...
        return self._get_policy_bundle_oapg(
            path_params=args.path,
        )

class GetPolicyBundle(BaseApi):
    ...
    async def aget_policy_bundle(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_policy_bundle(
            owner_id=owner_id,
            context=context,
            **kwargs,
        )
    ...
    def get_policy_bundle(
        ...
        raw_response = self.raw.get_policy_bundle(
            owner_id=owner_id,
            context=context,
        )
        if validate:
