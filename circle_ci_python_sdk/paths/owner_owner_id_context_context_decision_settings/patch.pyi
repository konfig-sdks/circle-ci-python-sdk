...
from circle_ci_python_sdk.model.decision_settings import DecisionSettings as DecisionSettingsSchema
...
from circle_ci_python_sdk.type.decision_settings import DecisionSettings
...
from circle_ci_python_sdk.pydantic.decision_settings import DecisionSettings as DecisionSettingsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DecisionSettingsSchema


request_body_decision_settings = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = DecisionSettingsSchema
...
class BaseApi(api_client.Api):
    ...
    def _modify_decision_settings_mapped_args(
        self,
        owner_id: str,
        context: str,
    ...
    async def _amodify_decision_settings_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/owner/{ownerID}/context/{context}/decision/settings',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_decision_settings.serialize(body, content_type)
    ...
    def _modify_decision_settings_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ModifyDecisionSettingsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amodify_decision_settings(
        self,
        owner_id: str,
        context: str,
        enabled: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._modify_decision_settings_mapped_args(
            owner_id=owner_id,
            context=context,
            enabled=enabled,
        )
        return await self._amodify_decision_settings_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def modify_decision_settings(
        self,
        owner_id: str,
        context: str,
        enabled: typing.Optional[bool] = None,
        ...
        return self._modify_decision_settings_oapg(
            body=args.body,
            path_params=args.path,
        )

class ModifyDecisionSettings(BaseApi):
    ...
    async def amodify_decision_settings(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DecisionSettingsPydantic:
        raw_response = await self.raw.amodify_decision_settings(
            owner_id=owner_id,
            context=context,
            enabled=enabled,
            **kwargs,
        ...
        if validate:
            return DecisionSettingsPydantic(**raw_response.body)
        return api_client.construct_model_instance(DecisionSettingsPydantic, raw_response.body)
    ...
    def modify_decision_settings(
        ...
        raw_response = self.raw.modify_decision_settings(
            owner_id=owner_id,
            context=context,
            enabled=enabled,
        )
