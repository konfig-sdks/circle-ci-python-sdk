...
class BaseApi(api_client.Api):
    ...
    def _get_project_claims_mapped_args(
        self,
        org_id: str,
        project_id: str,
    ...
    async def _aget_project_claims_oapg(
        self,
...
class GetProjectClaimsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_project_claims(
        self,
        org_id: str,
        project_id: str,
        **kwargs,
        ...
        args = self._get_project_claims_mapped_args(
            org_id=org_id,
            project_id=project_id,
        )
        return await self._aget_project_claims_oapg(
    ...
    def get_project_claims(
        ...
        return self._get_project_claims_oapg(
            path_params=args.path,
        )

class GetProjectClaims(BaseApi):
    ...
    async def aget_project_claims(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_project_claims(
            org_id=org_id,
            project_id=project_id,
            **kwargs,
        )
    ...
    def get_project_claims(
        ...
        raw_response = self.raw.get_project_claims(
            org_id=org_id,
            project_id=project_id,
        )
        if validate:
