...
# Query params
ClaimsSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'claims': typing.Union[ClaimsSchema, str, ],
    }
)
...
request_query_claims = api_client.QueryParameter(
    name="claims",
...
class BaseApi(api_client.Api):
    ...
    def _delete_project_claims_mapped_args(
        self,
        org_id: str,
        project_id: str,
        claims: str,
    ...
    async def _adelete_project_claims_oapg(
        self,
    ...
    def _delete_project_claims_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DeleteProjectClaimsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_project_claims(
        self,
        org_id: str,
        project_id: str,
        claims: str,
        **kwargs,
        ...
        args = self._delete_project_claims_mapped_args(
            org_id=org_id,
            project_id=project_id,
            claims=claims,
        )
        return await self._adelete_project_claims_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def delete_project_claims(
        self,
        org_id: str,
        project_id: str,
        claims: str,
        ...
        return self._delete_project_claims_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class DeleteProjectClaims(BaseApi):
    ...
    async def adelete_project_claims(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_project_claims(
            org_id=org_id,
            project_id=project_id,
            claims=claims,
            **kwargs,
    ...
    def delete_project_claims(
        ...
        raw_response = self.raw.delete_project_claims(
            org_id=org_id,
            project_id=project_id,
            claims=claims,
        )
