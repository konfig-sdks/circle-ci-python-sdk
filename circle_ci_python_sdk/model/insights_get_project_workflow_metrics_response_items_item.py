...
class InsightsGetProjectWorkflowMetricsResponseItemsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def metrics() -> typing.Type['InsightsGetProjectWorkflowMetricsResponseItemsItemMetrics']:
                return InsightsGetProjectWorkflowMetricsResponseItemsItemMetrics
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metrics"]) -> 'InsightsGetProjectWorkflowMetricsResponseItemsItemMetrics': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "metrics", "window_start", "window_end", "project_id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metrics"]) -> 'InsightsGetProjectWorkflowMetricsResponseItemsItemMetrics': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "metrics", "window_start", "window_end", "project_id", ], str]):
    ...
    ) -> 'InsightsGetProjectWorkflowMetricsResponseItemsItem':
