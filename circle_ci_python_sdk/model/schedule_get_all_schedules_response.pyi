...
class ScheduleGetAllSchedulesResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def items() -> typing.Type['ScheduleGetAllSchedulesResponseItems']:
                return ScheduleGetAllSchedulesResponseItems
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'ScheduleGetAllSchedulesResponseItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> 'ScheduleGetAllSchedulesResponseItems': ...
