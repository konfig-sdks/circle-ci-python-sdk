...
class PipelineListRecentPipelinesResponseItemsItemVcs(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def commit() -> typing.Type['PipelineListRecentPipelinesResponseItemsItemVcsCommit']:
                return PipelineListRecentPipelinesResponseItemsItemVcsCommit
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["commit"]) -> 'PipelineListRecentPipelinesResponseItemsItemVcsCommit': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["commit"]) -> typing.Union['PipelineListRecentPipelinesResponseItemsItemVcsCommit', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        commit: typing.Union['PipelineListRecentPipelinesResponseItemsItemVcsCommit', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'PipelineListRecentPipelinesResponseItemsItemVcs':
