...
class PipelineListWorkflowsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def items() -> typing.Type['PipelineListWorkflowsResponseItems']:
                return PipelineListWorkflowsResponseItems
    ...
    items: 'PipelineListWorkflowsResponseItems'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'PipelineListWorkflowsResponseItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> 'PipelineListWorkflowsResponseItems': ...
