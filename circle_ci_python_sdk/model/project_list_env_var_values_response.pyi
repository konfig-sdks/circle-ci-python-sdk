...
class ProjectListEnvVarValuesResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def items() -> typing.Type['ProjectListEnvVarValuesResponseItems']:
                return ProjectListEnvVarValuesResponseItems
    ...
    items: 'ProjectListEnvVarValuesResponseItems'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'ProjectListEnvVarValuesResponseItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> 'ProjectListEnvVarValuesResponseItems': ...
