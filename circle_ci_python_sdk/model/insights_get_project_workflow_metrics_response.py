...
class InsightsGetProjectWorkflowMetricsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def items() -> typing.Type['InsightsGetProjectWorkflowMetricsResponseItems']:
                return InsightsGetProjectWorkflowMetricsResponseItems
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'InsightsGetProjectWorkflowMetricsResponseItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> 'InsightsGetProjectWorkflowMetricsResponseItems': ...
