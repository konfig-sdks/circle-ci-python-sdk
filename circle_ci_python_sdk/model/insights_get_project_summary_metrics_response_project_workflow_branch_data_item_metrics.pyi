...
class InsightsGetProjectSummaryMetricsResponseProjectWorkflowBranchDataItemMetrics(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total_credits_used", "p95_duration_secs", "total_runs", "success_rate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total_credits_used", "p95_duration_secs", "total_runs", "success_rate", ], str]):
    ...
    ) -> 'InsightsGetProjectSummaryMetricsResponseProjectWorkflowBranchDataItemMetrics':
