...
class PipelineGetAllPipelinesResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def items() -> typing.Type['PipelineGetAllPipelinesResponseItems']:
                return PipelineGetAllPipelinesResponseItems
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'PipelineGetAllPipelinesResponseItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> 'PipelineGetAllPipelinesResponseItems': ...
