...
class InsightsGetProjectWorkflowJobMetricsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def items() -> typing.Type['InsightsGetProjectWorkflowJobMetricsResponseItems']:
                return InsightsGetProjectWorkflowJobMetricsResponseItems
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'InsightsGetProjectWorkflowJobMetricsResponseItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> 'InsightsGetProjectWorkflowJobMetricsResponseItems': ...
