...
class InsightsGetProjectWorkflowJobMetricsResponseItemsItemMetricsDurationMetrics(
    schemas.DictSchema
):
    """
    ...
    ) -> 'InsightsGetProjectWorkflowJobMetricsResponseItemsItemMetricsDurationMetrics':
