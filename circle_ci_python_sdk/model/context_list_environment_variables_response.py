...
class ContextListEnvironmentVariablesResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def items() -> typing.Type['ContextListEnvironmentVariablesResponseItems']:
                return ContextListEnvironmentVariablesResponseItems
    ...
    items: 'ContextListEnvironmentVariablesResponseItems'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'ContextListEnvironmentVariablesResponseItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> 'ContextListEnvironmentVariablesResponseItems': ...
