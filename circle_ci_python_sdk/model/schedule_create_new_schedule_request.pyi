...
class ScheduleCreateNewScheduleRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def parameters() -> typing.Type['ScheduleCreateNewScheduleRequestParameters']:
                return ScheduleCreateNewScheduleRequestParameters
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["parameters"]) -> 'ScheduleCreateNewScheduleRequestParameters': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["parameters", "name", "timetable", "attribution-actor", "description", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["parameters"]) -> 'ScheduleCreateNewScheduleRequestParameters': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["attribution-actor"]) -> MetaOapg.properties.attribution_actor: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["parameters", "name", "timetable", "attribution-actor", "description", ], str]):
        return super().get_item_oapg(name)
