...
class ContextListOwnerContextsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def items() -> typing.Type['ContextListOwnerContextsResponseItems']:
                return ContextListOwnerContextsResponseItems
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'ContextListOwnerContextsResponseItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> 'ContextListOwnerContextsResponseItems': ...
