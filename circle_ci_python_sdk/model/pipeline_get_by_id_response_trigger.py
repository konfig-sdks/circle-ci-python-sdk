...
class PipelineGetByIdResponseTrigger(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def actor() -> typing.Type['PipelineGetByIdResponseTriggerActor']:
                return PipelineGetByIdResponseTriggerActor
            __annotations__ = {
                "type": type,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actor"]) -> 'PipelineGetByIdResponseTriggerActor': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actor"]) -> 'PipelineGetByIdResponseTriggerActor': ...
    ...
    ) -> 'PipelineGetByIdResponseTrigger':
