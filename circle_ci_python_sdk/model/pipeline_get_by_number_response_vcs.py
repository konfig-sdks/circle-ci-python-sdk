...
class PipelineGetByNumberResponseVcs(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def commit() -> typing.Type['PipelineGetByNumberResponseVcsCommit']:
                return PipelineGetByNumberResponseVcsCommit
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["commit"]) -> 'PipelineGetByNumberResponseVcsCommit': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["commit"]) -> typing.Union['PipelineGetByNumberResponseVcsCommit', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        commit: typing.Union['PipelineGetByNumberResponseVcsCommit', schemas.Unset] = schemas.unset,
