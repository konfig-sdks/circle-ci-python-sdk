...
class ProjectListCheckoutKeysResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def items() -> typing.Type['ProjectListCheckoutKeysResponseItems']:
                return ProjectListCheckoutKeysResponseItems
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'ProjectListCheckoutKeysResponseItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> 'ProjectListCheckoutKeysResponseItems': ...
