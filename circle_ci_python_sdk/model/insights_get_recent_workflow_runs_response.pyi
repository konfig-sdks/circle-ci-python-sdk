...
class InsightsGetRecentWorkflowRunsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def items() -> typing.Type['InsightsGetRecentWorkflowRunsResponseItems']:
                return InsightsGetRecentWorkflowRunsResponseItems
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'InsightsGetRecentWorkflowRunsResponseItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> 'InsightsGetRecentWorkflowRunsResponseItems': ...
