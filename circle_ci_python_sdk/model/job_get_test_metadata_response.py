...
class JobGetTestMetadataResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def items() -> typing.Type['JobGetTestMetadataResponseItems']:
                return JobGetTestMetadataResponseItems
    ...
    items: 'JobGetTestMetadataResponseItems'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'JobGetTestMetadataResponseItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> 'JobGetTestMetadataResponseItems': ...
