...
class JobGetArtifactsResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def items() -> typing.Type['JobGetArtifactsResponseItems']:
                return JobGetArtifactsResponseItems
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'JobGetArtifactsResponseItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> 'JobGetArtifactsResponseItems': ...
