...
class InsightsGetProjectSummaryMetricsResponseProjectWorkflowBranchDataItemTrends(
    schemas.DictSchema
):
    """
    ...
    ) -> 'InsightsGetProjectSummaryMetricsResponseProjectWorkflowBranchDataItemTrends':
