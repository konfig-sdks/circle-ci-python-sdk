...
class PipelineListUserPipelinesResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def items() -> typing.Type['PipelineListUserPipelinesResponseItems']:
                return PipelineListUserPipelinesResponseItems
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'PipelineListUserPipelinesResponseItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> 'PipelineListUserPipelinesResponseItems': ...
