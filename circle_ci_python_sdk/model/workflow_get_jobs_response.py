...
class WorkflowGetJobsResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def items() -> typing.Type['WorkflowGetJobsResponseItems']:
                return WorkflowGetJobsResponseItems
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["items"]) -> 'WorkflowGetJobsResponseItems': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["items"]) -> 'WorkflowGetJobsResponseItems': ...
