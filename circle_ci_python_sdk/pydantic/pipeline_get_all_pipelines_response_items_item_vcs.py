...
from circle_ci_python_sdk.pydantic.pipeline_get_all_pipelines_response_items_item_vcs_commit import PipelineGetAllPipelinesResponseItemsItemVcsCommit

class PipelineGetAllPipelinesResponseItemsItemVcs(BaseModel):
    ...
    commit: typing.Optional[PipelineGetAllPipelinesResponseItemsItemVcsCommit] = Field(None, alias='commit')
    class Config:
