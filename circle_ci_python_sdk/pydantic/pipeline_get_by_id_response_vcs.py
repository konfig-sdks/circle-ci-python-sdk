...
from circle_ci_python_sdk.pydantic.pipeline_get_by_id_response_vcs_commit import PipelineGetByIdResponseVcsCommit

class PipelineGetByIdResponseVcs(BaseModel):
    ...
    commit: typing.Optional[PipelineGetByIdResponseVcsCommit] = Field(None, alias='commit')
    class Config:
