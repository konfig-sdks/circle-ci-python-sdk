...
from circle_ci_python_sdk.pydantic.pipeline_get_by_number_response_vcs_commit import PipelineGetByNumberResponseVcsCommit

class PipelineGetByNumberResponseVcs(BaseModel):
    ...
    commit: typing.Optional[PipelineGetByNumberResponseVcsCommit] = Field(None, alias='commit')
    class Config:
