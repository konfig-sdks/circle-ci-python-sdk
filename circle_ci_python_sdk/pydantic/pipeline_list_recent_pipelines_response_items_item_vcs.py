...
from circle_ci_python_sdk.pydantic.pipeline_list_recent_pipelines_response_items_item_vcs_commit import PipelineListRecentPipelinesResponseItemsItemVcsCommit

class PipelineListRecentPipelinesResponseItemsItemVcs(BaseModel):
    ...
    commit: typing.Optional[PipelineListRecentPipelinesResponseItemsItemVcsCommit] = Field(None, alias='commit')
    class Config:
