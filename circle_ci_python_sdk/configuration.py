...
from circle_ci_python_sdk.exceptions_base import ApiValueError
from circle_ci_python_sdk.exceptions import ClientConfigurationError
from circle_ci_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = circle_ci_python_sdk.Configuration(
...
conf = circle_ci_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://circleci.com/api/v2" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if api_key_header:
            self.api_key['api_key_header'] = api_key_header
        if api_key_query:
            self.api_key['api_key_query'] = api_key_query
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("circle_ci_python_sdk")
