...
from circle_ci_python_sdk.type.pipeline_get_by_number_response_vcs_commit import PipelineGetByNumberResponseVcsCommit

class RequiredPipelineGetByNumberResponseVcs(TypedDict):
...
class OptionalPipelineGetByNumberResponseVcs(TypedDict, total=False):
    ...
    commit: PipelineGetByNumberResponseVcsCommit

class PipelineGetByNumberResponseVcs(RequiredPipelineGetByNumberResponseVcs, OptionalPipelineGetByNumberResponseVcs):
    pass
