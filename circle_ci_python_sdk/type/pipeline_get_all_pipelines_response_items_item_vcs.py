...
from circle_ci_python_sdk.type.pipeline_get_all_pipelines_response_items_item_vcs_commit import PipelineGetAllPipelinesResponseItemsItemVcsCommit

class RequiredPipelineGetAllPipelinesResponseItemsItemVcs(TypedDict):
...
class OptionalPipelineGetAllPipelinesResponseItemsItemVcs(TypedDict, total=False):
    ...
    commit: PipelineGetAllPipelinesResponseItemsItemVcsCommit

class PipelineGetAllPipelinesResponseItemsItemVcs(RequiredPipelineGetAllPipelinesResponseItemsItemVcs, OptionalPipelineGetAllPipelinesResponseItemsItemVcs):
    pass
