...
from circle_ci_python_sdk.type.pipeline_list_user_pipelines_response_items_item_vcs_commit import PipelineListUserPipelinesResponseItemsItemVcsCommit

class RequiredPipelineListUserPipelinesResponseItemsItemVcs(TypedDict):
...
class OptionalPipelineListUserPipelinesResponseItemsItemVcs(TypedDict, total=False):
    ...
    commit: PipelineListUserPipelinesResponseItemsItemVcsCommit

class PipelineListUserPipelinesResponseItemsItemVcs(RequiredPipelineListUserPipelinesResponseItemsItemVcs, OptionalPipelineListUserPipelinesResponseItemsItemVcs):
    pass
